...
export default function ShareDesignModal({ isOpen, onClose, userData, onPostCreated }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (!designRes.ok) throw new Error('Error al crear el diseño');
            ...
            if (formData.visibility === 'public') {
                ...
                if (!postRes.ok) console.warn('Error al crear post, pero diseño guardado');
            }
            ...
            setError('No se pudo publicar el diseño. Intenta de nuevo.');
        } finally {
                ...
                <form className="modal-body" onSubmit={handleSubmit}>
                    ...
                    <div className="modal-actions">
                        ...
                        <button type="submit" className="btn-publish" disabled={isUploading || !selectedFile}>
                            {isUploading ? 'Publicando...' : 'Publicar Diseño'}
                        </button>
                    </div>
                </form>
            </div>
